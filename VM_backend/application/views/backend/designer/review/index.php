                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="table-responsive">
                                <table id="dt_basic" class="table table-bordered table-striped text-center">
                                    <thead>
                                        <tr>
                                            <th width="200" class="text-center">Member</th>
                                            <th width="200" class="text-center">Product</th>
                                            <th class="text-center">Review</th>
                                            <th width="200" class="text-center">Score</th>
...
<script>
    $(document).ready(function () {
        ...
        var $Table = $('#dt_basic').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url("backend/ajax/designer/review/get_review_data") ?>",
                "data": function (data) {
