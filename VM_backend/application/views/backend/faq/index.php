                                ...
                                <table id="dt_basic" class="table table-bordered table-striped text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center hidden-md">Content</th>
            ...
            "oTableTools": {
                "aButtons": [{
                    ...
                    "fnClick": function (nButton, oConfig, oFlash) {
                        $(nButton).parents('form:first').attr('action', 'faq/save').submit();
                    }
                }, {
                    "sExtends": "text",
                    "sButtonText": '<i class="fa fa-plus" style="color:white"></i> <span style="color:white">Add Faq</span>',
                    "sButtonClass": "btn-lg btn-primary",
                    "fnInit": function (nButton, oConfig) {
                        $(nButton).css('margin-left', 5).css('text-shadow','0 -1px 0 rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3)');
                    },
                    "fnClick": function (nButton, oConfig, oFlash) {
                        $(nButton).attr('href', 'faq/add/');                        
                    }
                }]
            },
            "ajax": {
                "url": "<?= site_url("backend/ajax/help/faq/get_faq_data") ?>",
                "data": function (data) {
