                    ...
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="tab-pane" id="hb<?= $i++ ?>">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" name="langList[<?= $lrow->langId ?>][content]" rows="10" id="content-<?= $lrow->langId ?>" data-bv-notempty="true" data-bv-notempty-message=" "></textarea>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </div>
                            ...
                            <div class="widget-footer">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/help/faq" . $this->query) ?>';">Return</button>
                            </div>
                        </form>
                    </div>
                </div>
