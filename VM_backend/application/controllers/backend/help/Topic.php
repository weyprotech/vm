...
class Topic extends Backend_Controller
{
    ...
    public function add()
    {
        ...
        if($post = $this->input->post(null,true)){
            ...
            if($this->input->get('back',true)){
                redirect("backend/help/topic/index");
            }
            redirect('backend/help/topic/edit/' . $topicId . $this->query);
        }
    ...
    public function edit($topicId = false)
    {
        ...
        if ($post = $this->input->post(null, true)):
            ...
            if ($row->uuid != $post['uuid']):
                ...
                if ($this->input->get('back', true)):
                    redirect('backend/help/topic' . $this->query);
                endif;
            endif;
    ...
    {
        $content = $this->load->view('backend/help/feedback/topic/' . $page, $data, true);
