                    ...
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-lg-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control datepicker" id="date" name="date" value="<?= $row->date ?>" data-dateformat="yy-mm-dd" placeholder="choice">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <p class="help-block">
                                                    <strong>Note:</strong> Resolution is <strong>1920 x 826</strong>. Format is JPG and PNG</strong>。
                                                </p>
                            ...
                            <div class="widget-footer">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/designer/banner/index/".$row->designerId . $this->query) ?>';">Return</button>
                            </div>
                        </form>
                    </div>
                </div>
