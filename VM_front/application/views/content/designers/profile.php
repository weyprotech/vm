        ...
        <div class="block_inner">
            <div class="topping_header">
                <div class="thumb">
                    ...
                    <div class="pic" style="background-image: url(<?= backend_url($row->designImg) ?>);"><img class="size" src="<?= base_url('assets/images/size_3x4.png') ?>"></div>
                    <!--↑ 3:4，顯示的圖片放在 pic 的 background-image，img.size 是撐開用的透明圖 ↑-->
                </div>
            </div>
            <div class="topping_main in_detail">
                ...
                <div class="designer_info">
                    ...
                    <a class="btn_favorite" href="javascript:;" data-designerId="designer001" title="Favorite">
                        <i class="icon_favorite_heart"></i><span>(<span class="count">1207</span>)</span>
                    </a>
                </div>
