                                        ...
                                        <div class="tab-pane" id="hb<?= $i++ ?>">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="name-<?= $lrow->langId ?>">About Us Content</label>

                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" name="langList[<?= $lrow->langId ?>][about]" rows="10" data-bv-notempty="true" data-bv-notempty-message=" "><?= $row->langList[$lrow->langId]->about ?></textarea>
                                                    </div>
                                                </div>   
                                                
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="name-<?= $lrow->langId ?>">Physical Store Content</label>

                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" name="langList[<?= $lrow->langId ?>][store]" rows="10" data-bv-notempty="true" data-bv-notempty-message=" "><?= $row->langList[$lrow->langId]->store ?></textarea>                                                        
                                                    </div>
                                                </div> 

                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="name-<?= $lrow->langId ?>">Terms and Policy Content</label>

                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" name="langList[<?= $lrow->langId ?>][policy]" rows="10" data-bv-notempty="true" data-bv-notempty-message=" "><?= $row->langList[$lrow->langId]->policy ?></textarea>                                                        
                                                    </div>
                                                </div> 

                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="name-<?= $lrow->langId ?>">Cooperation Content</label>

                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" name="langList[<?= $lrow->langId ?>][cooperation]" rows="10" data-bv-notempty="true" data-bv-notempty-message=" "><?= $row->langList[$lrow->langId]->cooperation ?></textarea>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </div>
