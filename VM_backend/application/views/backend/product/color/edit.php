                    ...
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data"
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9 col-lg-4">
                                                        <input class="form-control" type="text" id="name-<?= $lrow->langId ?>" name="langList[<?= $lrow->langId ?>][color]" value="<?= $row->langList[$lrow->langId]->color ?>" required>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </div>
                            ...
                            <div class="widget-footer">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/product/color/index/".$row->pId . $this->query) ?>';">Return</button>
                            </div>
                        </form>
                    </div>
                </div>
