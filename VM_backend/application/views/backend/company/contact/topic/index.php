                                ...
                                <table id="dt_basic" class="table table-bordered table-striped text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200" class="text-center">Topic</th>
    ...
    $(document).ready(function () {
        ...
        var $Table = $('#dt_basic').DataTable({
            ...
            "oTableTools": {
                "aButtons": [{
                    "sExtends": "text",
                    "sButtonText": '<i class="fa fa-plus" style="color:white"></i> <span style="color:white">Add Topic</span>',
                    ...
                    "fnClick": function (nButton, oConfig, oFlash) {
                        $(nButton).attr('href', 'topic/add/');                        
                    }
                }]
            },
            "ajax": {
                "url": "<?= site_url("backend/ajax/company/topic/get_topic_data") ?>",
                "data": function (data) {
                },
                "type":'post'
            },
