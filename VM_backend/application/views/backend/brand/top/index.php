                                ...
                                <div class="tab-pane" id="hb<?= $i++ ?>">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">First(import)</label>
                                            <input type="hidden" name="data[0][Id]" value=1>
                                            <div class="col-sm-9 col-lg-4">
                                                <select class="form-control" name="data[0][brandId]">
                                                    <?php foreach($brandList as $brandKey => $brandValue){ ?>
                                                        <option value="<?= $brandValue->brandId ?>" <?= $topList[0]->brandId == $brandValue->brandId ? 'selected' : '' ?>><?= $brandValue->name ?></option>
                                                    <?php } ?>
                                               </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-4">
                                                <select class="form-control" name="data[1][brandId]">
                                                    <?php foreach($brandList as $brandKey => $brandValue){ ?>
                                                        <option value="<?= $brandValue->brandId ?>" <?= $topList[1]->brandId == $brandValue->brandId ? 'selected' : '' ?>><?= $brandValue->name ?></option>
                                                    <?php } ?>
                                               </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-4">
                                                <select class="form-control" name="data[2][brandId]">
                                                    <?php foreach($brandList as $brandKey => $brandValue){ ?>
                                                        <option value="<?= $brandValue->brandId ?>" <?= $topList[2]->brandId == $brandValue->brandId ? 'selected' : '' ?>><?= $brandValue->name ?></option>
                                                    <?php } ?>
                                               </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-4">
                                                <select class="form-control" name="data[3][brandId]">
                                                    <?php foreach($brandList as $brandKey => $brandValue){ ?>
                                                        <option value="<?= $brandValue->brandId ?>" <?= $topList[3]->brandId == $brandValue->brandId ? 'selected' : '' ?>><?= $brandValue->name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
