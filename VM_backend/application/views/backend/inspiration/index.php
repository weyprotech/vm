                            ...
                            <div class="table-responsive">
                                <table id="dt_basic" class="table table-bordered table-striped text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th width="60" class="text-center hidden-tablet">Banner</th>
                                        <th width="60" class="text-center hidden-tablet">Comments</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $Table = $('#dt_basic').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url("backend/ajax/inspiration/inspiration/get_inspiration_data") ?>",
                "data": function (data) {
                }
            },
            "columns": [
                ...
                {class: "hidden-tablet", data: "banner"},
                {class: "hidden-tablet", data: "comments"},
                {class: "", data: "action"}
            ],
