                                ...
                                <table id="dt_basic" class="table table-bordered table-striped text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200" class="text-center">Area</th>
                                            <th width="200" class="text-center">Area Number</th>
    ...
    $(document).ready(function () {
        ...
        var $Table = $('#dt_basic').DataTable({
            ...
            "oTableTools": {
                "aButtons": [{
                    "sExtends": "text",
                    "sButtonText": '<i class="fa fa-plus" style="color:white"></i> <span style="color:white">Add Area Number</span>',
                    ...
                    "fnClick": function (nButton, oConfig, oFlash) {
                        $(nButton).attr('href', 'area_number/add/');                        
                    }
                }]
            },
            "ajax": {
                "url": "<?= site_url("backend/ajax/company/area_number/get_area_number_data") ?>",
                "data": function (data) {
                },
                "type":'post'
            },
