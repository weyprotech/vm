                    ...
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data"
                                ...
                                <div class="tab-pane" id="hb<?= $i++ ?>">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <input type="text" class="form-control EUR_title" name="eur_value" data-bv-notempty="true" data-bv-notempty-message=" ">                                                     
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <input type="text" class="form-control EUR_title" name="twd_value" data-bv-notempty="true" data-bv-notempty-message=" ">                                                    
                                            </div>
                            ...
                            <div class="widget-footer">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/money/money" . $this->query) ?>';">Return</button>
                            </div>
                        </form>
                    </div>
                </div>
