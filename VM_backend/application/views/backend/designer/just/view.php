                    ...
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data"
                                ...
                                <div class="tab-pane" id="hb<?= $i++ ?>">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" id="product" value="<?= @$row->name ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="10" readonly><?= @$row->message ?></textarea>                                                
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                            ...
                            <div class="widget-footer">                                
                                <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/designer/just/index/".$designerId . $this->query) ?>';">Return</button>
                            </div>
                        </form>
                    </div>
                </div>
