                            ...
                            <div id="content" class="tab-content">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input class="form-control" type="password" id="password" name="password" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input type="password" class="form-control" id="re_password" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input class="form-control" type="text" id="first_name" name="first_name" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input class="form-control" type="text" id="last_name" name="last_name" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <label class="radio radio-inline">
                                                <input type="radio" class="radiobox" name="gender" value="0" checked>
                                                <span>Men</span>
                                            </label>

                                            <label class="radio radio-inline">
                                                <input type="radio" class="radiobox" name="gender" value="1">
                                                <span>Women</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input class="form-control" type="number" id="age" name="age" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input class="form-control" type="text" id="phone_area_code" name="phone_area_code" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input class="form-control" type="text" id="phone" name="phone" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-6">
                                            <input class="form-control" type="text" id="state" name="state" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="address">Address</label>
                                        <div class="col-sm-9 col-lg-6">
                                            <input type="text" class="form-control" id="address" name="address" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
