    ...
    $(document).ready(function () {
        ...
        $Table = $('#dt_basic').DataTable({
            ...
            "oTableTools": {
                "aButtons": [{
                    "sExtends": "text",
                    "sButtonText": '<i class="fa fa-plus" style="color:white"></i> <span class="hidden-mobile" style="color:white">Add Fabric</span>',
            ...
            "ajax": {
                "url": "<?= site_url("backend/ajax/fabric/fabric/get_fabric_data") ?>",
                "data": function (data) {
                }
            },
            "columns": [
