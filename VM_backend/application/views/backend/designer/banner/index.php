            ...
            "oTableTools": {
                "aButtons": [{
                    ...
                    "fnClick": function (nButton, oConfig, oFlash) {
                        $(nButton).parents('form:first').attr('action',  '<?= site_url('backend/designer/banner/save/'.$designerId) ?>').submit();
                    }
                }, {
                    "sExtends": "text",
                    ...
                    "fnInit": function (nButton, oConfig) {
                        $(nButton).css('margin-left', 5).css('text-shadow','0 -1px 0 rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3)').attr('href', '<?= site_url("backend/designer/banner/add/".$designerId) ?>');
                    }
                }]
            },
            "ajax": {
                "url": "<?= site_url("backend/ajax/designer/banner/get_banner_data") ?>",
                "data": function (data) {
