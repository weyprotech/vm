                            ...
                            <div class="table-responsive">
                                <table id="dt_basic" class="table table-bordered table-striped text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th width="200" class="text-center">Main Title</th>
    ...
    $(document).ready(function () {
        ...
        $Table = $('#dt_basic').DataTable({
            ...
            "oTableTools": {
                "aButtons": [{
                    "sExtends": "text",
                    "sButtonText": '<i class="fa fa-plus" style="color:white"></i> <span class="hidden-mobile" style="color:white">Add Manufacturer</span>',
            ...
            "ajax": {
                "url": "<?= site_url("backend/ajax/manufacturer/manufacturer/get_manufacturer_data") ?>",
                "data": function (data) {
                }
            },
            "columns": [
