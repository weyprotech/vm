...
<script>
    ...
    $(document).ready(function () {
            ...
            "oTableTools": {
                "aButtons": [{
                    ...
                    "fnInit": function (nButton, oConfig) {
                        $(nButton).css('margin-left', 5).css('text-shadow','0 -1px 0 rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3)').attr('data-toggle',"modal").attr('data-target',"#myModal");
                        // .attr('href', 'sale_product/get_product/');
        ...
        var $model_Table = $('#dt_basic').DataTable({
            ...
            "serverSide": true,
            "deferRender":true,
            "sDom": "<'dt-toolbar'<'col-sm-10 hidden-xs' f<'main-select input-group'><'minor-select input-group'><'category-select input-group'>><'col-xs-12 col-sm-2'Tl>>" + "t" + "<'dt-toolbar-footer'<'col-sm-6 col-xs-12 hidden-xs'i><'col-xs-12 col-sm-6'p>>",
            "oTableTools": {
                "aButtons": []
            },
            "ajax": {
