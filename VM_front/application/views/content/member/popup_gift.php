    ...
    <form class="form_wrapper" method="post">
      <div class="form_block">
        <div class="controls_group">
          ...
          <div class="controls">
            <input type="text" placeholder="NT$"/>
          </div>
        </div>
        <div class="controls_group">
          ...
          <div class="controls row">
            <div class="grid g_6_12">
              <div class="btn_radio">
                <input id="payment1" type="radio" name="payment" checked="checked"/>
      ...
      <div class="call_action">
        <button class="btn common popup_modal_dismiss" type="button">Send</button>
