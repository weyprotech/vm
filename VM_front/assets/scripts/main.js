function sticky() {
  windowWidth >= 1024
    ? $("#header .header_nav_wrap").sticky({ topSpacing: 0, zIndex: 10001 })
    : windowWidth < 1024 &&
    ($("#header").sticky({ topSpacing: 0, zIndex: 10001 }),
...
function scaleCaptcha() {
  ...
  if (
    ...
    var t = e / 304;
    $(".captcha").css({ width: 304 * t + "px", height: 78 * t + "px" }),
      $(".captcha .captcha_inner").css({ transform: "scale(" + t + ")" });
  } else
    $(".captcha").css({ width: "", height: "" }),
      $(".captcha .captcha_inner").css({ transform: "" });
}
...
$(document).ready(function () {
  if (
    ($(".retina").retina(),
      ...
      $("#btn_menu").on(clickHandler, function (e) {
        e.preventDefault(),
          $(this).toggleClass("active"),
          $("#sidebar").trigger("sidebar:toggle").toggleClass("active");
      }),
      $(".sidebar_menu > ul > li > a").on(clickHandler, function (e) {
        var t = $(this).attr("href");
        $(this).siblings(".sub_menu").length > 0 &&
          (e.preventDefault(),
      ...
      $(".header_nav > ul > li").on("mouseenter", function (e) {
        $(this).children("a").addClass("active"),
          $(this).children(".sub_menu").length > 0 &&
          $(this)
            .children(".sub_menu")
            .stop()
            .animate({ height: "show", opacity: 1 }, "500");
      }),
      $(".header_nav > ul > li").on("mouseleave", function (e) {
        $(this).children("a").removeClass("active"),
          $(this).children(".sub_menu").length > 0 &&
          $(this)
            .children(".sub_menu")
            .stop()
            .animate({ height: "hide", opacity: 0 }, "300");
      }),
      $("#header").on(clickHandler, ".option_search a", function (e) {
        e.preventDefault(), $("#header .header_search").stop().slideToggle();
      }),
      $(document).on(clickHandler, function (e) {
        !$(e.target).is(
          "#header .option_search a, #header .option_search a *, #header .header_search, #header .header_search *"
        ) &&
          windowWidth < 1024 &&
          $("#header .header_search").stop().slideUp();
      }),
      $("#header").on(clickHandler, ".option_cart a.cart_toggle", function (e) {
        e.preventDefault(),
          $(this).hasClass("active")
      ...
      $(document).on(clickHandler, function (e) {
        $(e.target).is("#header .option_cart, #header .option_cart *") ||
          ($("#header .option_cart a.cart_toggle").removeClass("active"),
            $("#header .option_cart .cart_drop").stop().fadeOut());
      }),
      $(".dropdown_menu").length > 0 &&
      ($(".dropdown_menu").on(clickHandler, ".dropdown_head", function (e) {
        $(this).next(".dropdown_list").stop().slideToggle();
      }),
        $(".dropdown_menu").on(clickHandler, ".dropdown_list a", function (e) {
          if ($(this).parents(".dropdown_menu").hasClass("dropdown_select")) {
            var t = $(this).text();
            $(this)
              .addClass("current")
              .parent("li")
          ...
          $(this).parents(".dropdown_list").stop().slideUp();
        }),
        $(document).on(clickHandler, function (e) {
          $(e.target).is(".dropdown_menu, .dropdown_menu *") ||
            $(".dropdown_menu .dropdown_list").stop().slideUp();
        })),
      $(".captcha").length > 0 && scaleCaptcha(),
      $(".top_designers_slider").length > 0 &&
      ...
      $(".aside_products_slider").length > 0 &&
      ...
      $(".scrollbar_x").length > 0 &&
      $(".scrollbar_x").mCustomScrollbar({ theme: "dark-3", axis: "x" }),
      $(".scrollbar_y").length > 0 &&
      $(".scrollbar_y").mCustomScrollbar({ theme: "dark-3", axis: "y" }),
      $(".topping_block .topping_list").length > 0 && toppingListScroll(),
      $(".sort_menu").length > 0 &&
      $(".sort_menu").mCustomScrollbar({ theme: "dark-2", axis: "x" }),
      $(".ootd_list").length > 0)
  ) {
    var e = $(".ootd_list").masonry({
      temSelector: ".item",
    ...
    $(".share_links")
      ...
      .each(function () {
        $(this).hasClass("facebook")
          ? $(this).attr("href", "https://www.facebook.com/sharer.php?u=" + i)
          : $(this).hasClass("pinterest")
            ? $(this).attr(
              "href",
              "http://pinterest.com/pin/create/link/?url=" + i
            )
            : $(this).hasClass("twitter")
              ? $(this).attr(
                "href",
                "https://twitter.com/intent/tweet?url=" + i + "&text=" + s
              )
              : $(this).hasClass("weibo") &&
              $(this).attr(
                "href",
  ...
  $(".comments_block").length > 0 &&
    $(".comments_block").on(clickHandler, ".comments_title", function () {
      $(this)
        .toggleClass("active")
        .next(".comments_content")
        .stop()
        .slideToggle();
    }),
    $(".designer_header").length > 0 &&
    ($(".designer_navigation .nav_menu").on(
      clickHandler,
      ".toggle_menu",
      function (e) {
        $(this)
          ...
          .slideToggle(function (e) {
            $(this).parent(".nav_menu").toggleClass("open"),
              $(this).parent(".nav_menu").hasClass("open") ||
              ($(this).find("a").removeClass("active"),
                $(this).find("ul").stop().hide());
          });
      }
    ),
      $(".designer_navigation .nav_menu ul").on(clickHandler, "a", function (
        e
      ) {
        $(this)
          .siblings("ul")
      ...
      $(document).on(clickHandler, function (e) {
        !$(e.target).is(
          ".designer_navigation .nav_menu, .designer_navigation .nav_menu *"
        ) &&
          windowWidth >= 1024 &&
          $(".designer_navigation .nav_menu ul")
            .find("a.active")
            .removeClass("active")
            .siblings("ul")
            .stop()
    ...
    $(".fit_video").length > 0 && $(".fit_video").fitVids(),
    $(".fold_block").length > 0 &&
    $(".fold_block").on(clickHandler, ".fold_title", function (e) {
      if (
        $(this).parents(".fold_block").hasClass("aside_menu") &&
        windowWidth >= 1024
      )
        return !1;
      $(this)
      ...
      callbacks: {
        ajaxContentAdded: function () {
          if ($(".popup_slider").length > 0) {
            var e,
              t = 0;
            void 0 !== this.st.el.attr("data-index") &&
              (t = this.st.el.attr("data-index")),
              $(".popup_slider").on("init", function (t, i) {
                $(".popup_slider").fitVids(),
                  clearTimeout(e),
                  (e = setTimeout(function () {
                    var e = $(".popup_slider")
                      .find(".slide.slick-current")
                      .outerHeight();
                    $(".popup_slider")
                      .find(".slick-track")
                      .css("height", e + "px");
              ...
              $(".popup_slider").on("afterChange", function (t, i, s) {
                clearTimeout(e),
                  (e = setTimeout(function () {
                    var e = $(".popup_slider")
                      .find(".slide.slick-current")
              ...
              $(".popup_slider").slick("slickGoTo", t);
          }
        },
      },
    }),
    $(document).on(clickHandler, ".popup_modal_dismiss", function (e) {
      $.magnificPopup.close();
    }),
    $(".rate_star").length > 0 &&
    $(".rate_star").rateYo({
    ...
    $(window).on("scroll", function () {
      $(window).scrollTop() > 100
        ...
        ($(window).scrollTop() +
          ...
          : $("#fixedButtons").css({ position: "", top: "", bottom: "" }));
    }),
    $("#backTop").length > 0 &&
    $("#backTop").on(clickHandler, function (e) {
      e.preventDefault(),
        ...
        if (
          ...
          s.length > 0 &&
            $("html, body")
              .stop()
              .animate(
                { scrollTop: s.offset().top - $("#header").outerHeight() },
                800
              );
        }
      });
    ...
    i.length > 0 &&
      ($("html, body").scrollTop(0),
        $("html, body")
          .stop()
          .animate(
            { scrollTop: i.offset().top - $("#header").outerHeight() },
            800
          )),
