                ...
                <div>
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data"
                            ...
                            <input type="hidden" name="uuid" value="<?= $runway[0]->uuid ?>">
                            ...
                            <div id="content" class="tab-content"><?php $i = 1; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <label class="radio radio-inline">
                                                    <input type="radio" class="radiobox" name="is_visible" value="1" <?= $runway[0]->is_visible ? "checked" : "" ?>>
                                                    <span>Yes</span>
                                                </label>

                                                <label class="radio radio-inline">
                                                    <input type="radio" class="radiobox" name="is_visible" value="0" <?= !$runway[0]->is_visible ? "checked" : "" ?>>
                                                    <span>No</span>
                                                </label>
                                            </div>
                                        </div>                                       
                                ...
                                <?php if ($this->langList): ?>
                                    <?php foreach ($this->langList as $lrow): ?>
                                        <?php $langData = @$runway[0]->langList[$lrow->langId]; ?>
                                        <div class="tab-pane" id="hb<?= $i++ ?>">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" type="text" id="title-<?= $lrow->langId ?>" name="langList[<?= $lrow->langId ?>][title]" value="<?= @$langData->title ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                                    </div>
                                                </div>
...
<script>
    ...
    function imgUpload(Id)
    {
        ...
        swal({
            ...
            html:'<input type="file" id="transactionImg" multiple="multiple" onchange="change_img()" class="swal2-file transactionImg" placeholder="" style="display: block;width:92%"><br><span stle="float:left">Youtube</span><input type="text" id="youtube" name="youtube" style="width:80%"></p>'
        }).then(function (e) {
