                            ...
                            <div id="content" class="tab-content"><?php $i = 1; ?>
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label class="radio radio-inline">
                                                <input type="radio" class="radiobox" name="usable" value="1" <?= $row->usable == 1 ? "checked" : "" ?>>
                                                <span>Yes</span>
                                            </label>

                                            <label class="radio radio-inline">
                                                <input type="radio" class="radiobox" name="usable" value="0" <?= $row->usable == 0 ? "checked" : "" ?>>
                                                <span>No</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" id="Code" name="Code" value="<?= $row->code ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" id="coupon_money" name="coupon_money" value="<?= $row->coupon_money ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                        </div>
                                    </div>
                                </fieldset> 
                            </div>
