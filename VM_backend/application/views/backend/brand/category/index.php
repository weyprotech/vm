    ...
    $(document).ready(function () {
        ...
        var $Table = $('#dt_basic').DataTable({
            ...
            "oTableTools": {
                "aButtons": [{
                    "sExtends": "text",
                    "sButtonText": '<i class="fa fa-plus" style="color:white"></i> <span class="hidden-mobile" style="color:white">Add Category</span>',
                    "sButtonClass": "btn-lg btn-primary",
                    "fnInit": function (nButton, oConfig) {
                        $(nButton).css('margin-left', 5).css('text-shadow','0 -1px 0 rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3)').attr('href', '<?= site_url("backend/brand/category/add/") ?>');
                    }
                }]
            },
            "ajax": {
                "url": "<?= site_url("backend/ajax/brand/category/get_category_data") ?>",
                "data": ""
            },
            "columns": [
