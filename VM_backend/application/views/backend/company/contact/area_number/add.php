                                        ...
                                        <div class="tab-pane" id="hb<?= $i++ ?>">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text" id="name-<?= $lrow->langId ?>" name="langList[<?= $lrow->langId ?>][area]" data-bv-notempty="true" data-bv-notempty-message=" ">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text" id="name-<?= $lrow->langId ?>" name="langList[<?= $lrow->langId ?>][number]" data-bv-notempty="true" data-bv-notempty-message=" ">
                                                    </div>
                                                </div>                                           
                                            </fieldset>
                                        </div>
