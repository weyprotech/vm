                ...
                <div>
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data"
                            ...
                            <input type="hidden" id="Id" name="Id" value="<?= $reviewId ?>">
                                ...
                                <div class="tab-pane" id="hb<?= $i++ ?>">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" id="member" value="<?= $row->member_first_name.$row->member_last_name ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" id="product" value="<?= @$row->product_name ?>" readonly>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="score">Score</label>

                                            <div class="col-sm-6">
                                                <input class="form-control" type="text" id="score" value="<?= @$row->score ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="10" readonly><?= @$row->review ?></textarea>                                                
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="response" rows="10" data-bv-notempty="true" data-bv-notempty-message=" "><?= @$row->response ?></textarea>                                                
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                            ...
                            <div class="widget-footer">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/designer/review/index/".$designerId . $this->query) ?>';">Return</button>
                            </div>
                        </form>
                    </div>
                </div>
