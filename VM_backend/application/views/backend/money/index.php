...
<script>
    ...
    $(document).ready(function () {
        ...
        $Table = $('#dt_basic').DataTable({
            ...
            "ordering": false,
            "serverSide": true,
            "sDom": "<'dt-toolbar'<'col-sm-7 hidden-xs' f><'col-xs-12 col-sm-5'l>>" + "t" + "<'dt-toolbar-footer'<'col-sm-6 col-xs-12 hidden-xs'i><'col-xs-12 col-sm-6'p>>",
            "ajax": {
                "url": "<?= site_url("backend/ajax/money/money/get_money_data") ?>",
                "data": function (data) {
                }
            },
            "columns": [
