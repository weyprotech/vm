                ...
                <div>
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data"
                            ...
                            <input type="hidden" name="physical_storeId" value="<?= $row->physical_storeId ?>">
                                ...
                                <div class="tab-pane active" id="hb<?= $i++ ?>">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="map_url" value="<?= $row->map_url ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="address_url" value="<?= $row->address_url ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <?php if ($this->langList): ?>
                                    <?php foreach ($this->langList as $lrow): ?>
                                        <div class="tab-pane" id="hb<?= $i++ ?>">
                                            <input type="hidden" name="langList[<?= $lrow->langId ?>][pId]" value="<?= $row->physical_storeId ?>">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text" id="name-<?= $lrow->langId ?>" name="langList[<?= $lrow->langId ?>][address]" value="<?= $row->langList[$lrow->langId]->address ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text" id="name-<?= $lrow->langId ?>" name="langList[<?= $lrow->langId ?>][phone]" value="<?= $row->langList[$lrow->langId]->phone ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text" id="name-<?= $lrow->langId ?>" name="langList[<?= $lrow->langId ?>][time]" value="<?= $row->langList[$lrow->langId]->time ?>" data-bv-notempty="true" data-bv-notempty-message=" ">
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </div>
