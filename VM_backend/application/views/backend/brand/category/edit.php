                    ...
                    <div class="widget-body no-padding">
                        <form id="data-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="widget-footer">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/brand/category/index/".$row->categoryId . $this->query) ?>';">Return</button>
                            </div>
                        </form>
                    </div>
                </div>
