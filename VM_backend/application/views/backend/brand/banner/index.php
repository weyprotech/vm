                            ...
                            <div class="table-responsive">
                                <table id="dt_basic" class="table table-bordered table-striped text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th width="50%" class="text-center hidden-tablet hidden-md">img</th>
            ...
            "oTableTools": {
                "aButtons": [{
                    ...
                    "fnClick": function (nButton, oConfig, oFlash) {
                        $(nButton).parents('form:first').attr('action',  '<?= site_url('backend/brand/banner/save/'.$brandId) ?>').submit();
                    }
                }, {
                    "sExtends": "text",
                    ...
                    "fnInit": function (nButton, oConfig) {
                        $(nButton).css('margin-left', 5).css('text-shadow','0 -1px 0 rgba(0, 0, 0, 0.5), 0 1px 0 rgba(255, 255, 255, 0.3)').attr('href', '<?= site_url("backend/brand/banner/add/".$brandId) ?>');
                    }
                }]
            },
            "ajax": {
                "url": "<?= site_url("backend/ajax/brand/banner/get_banner_data") ?>",
                "data": function (data) {
